...
def makepayment(request):
    ...
    client = razorpay.Client(auth=("rzp_test_rgTESUL3KMT67s", "oZQMkTbOCtUAb0MLGhMCunh7"))
    data = { "amount": 14900, "currency": "INR", "receipt": "order_rcptid_11" }
